...
namespace Discore.Audio
{
    ...
    internal abstract partial class OpusConverter : IDisposable
    {
        ...
        protected OpusConverter(int samplingRate, int channels, int frameLength)
        {
            ...
            { //Linux*
                Opus = new Discore.Audio.OpusConverter.UnsafeNativeMethods.OpusLinux();
            } else if (os.Contains("windows"))
            { //Microsoft
                Opus = new Discore.Audio.OpusConverter.UnsafeNativeMethods.OpusWindows();
            } else if (os.Contains("darwin"))
            { //Mac
                Opus = new Discore.Audio.OpusConverter.UnsafeNativeMethods.OpusDarwin();
            } else
            {
