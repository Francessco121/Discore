namespace Discore.Http
{
    ...
    public abstract class DiscordIdObject
    {
        ...
        // Have empty constructor for types such as GuildMember which do not have a unique id,
        // and let the inherited class locate it.
        protected DiscordIdObject() { }

        protected DiscordIdObject(DiscordApiData data)
        {
